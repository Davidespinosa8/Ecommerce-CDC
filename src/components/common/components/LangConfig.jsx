  ...
  en: {
    translation: {
      ...
      footer: {
        ...
        support: "Support",
        address: "Segurola and Habana 4310, 7th floor, Federal Capital, Argentina",
  ...
  gr: {
    translation: {
      ...
      footer: {
        ...
        address: "Segurola und Habana 4310, 7. Stock, Hauptstadtregion, Argentinien",
  ...
  ar: {
    translation: {
      ...
      footer: {
        ...
        support: "الدعم",
        address: "سيغورولا و هابانا 4310 الطابق السابع، العاصمة الفيدرالية، الأرجنتين",
  ...
  es: {
    translation: {
      ...
      footer: {
        ...
        support: "Soporte",
        address: "Segurola y Habana 4310 7mo piso, Capital Federal, Argentina",
