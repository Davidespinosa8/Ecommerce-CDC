      ...
      <Container>
        ...
        >
          ...
          >
            ...
            <Typography variant="body2">legionserviciosdigitales@gmail.com</Typography>
            <Typography variant="body2">+0303456</Typography>
          </Grid>
          ...
          >
            ...
            <div className="mt-4 flex items-center gap-2">
              ...
              <Link href="https://www.instagram.com/legiondigital__/" className="mr-4">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
              ...
              <Link href="https://www.linkedin.com/in/dar%C3%ADo-david-espinosa-b50972258/" className="mr-4">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
